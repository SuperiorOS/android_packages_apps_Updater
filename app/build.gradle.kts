...
import org.superioros.generatebp.GenerateBpPlugin
import org.superioros.generatebp.GenerateBpPluginExtension
import org.superioros.generatebp.models.Module
...
buildscript {
    ...
    dependencies {
        classpath("org.superioros:gradle-generatebp:+")
    }
}
...
android {
    ...
    defaultConfig {
        applicationId = "org.superioros.updater"
        minSdk = 30
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
